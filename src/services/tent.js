(function(window) {
    ...
    function setupTent(tentData, settings) {
        var tent_posts = tentData[0],
            tent_profile = tentData[1],
            tent_followers = tentData[2],
            tent_followings = tentData[3],
            tent_posts_count = tentData[4];
    ...
    window.tentService = {
        ...
        template: "templates/tent-view.html",
        setup: setupTent,
        fetch: fetchData
    };
})(window);
